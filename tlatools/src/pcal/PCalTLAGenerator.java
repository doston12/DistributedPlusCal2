...
public class PCalTLAGenerator
{
    ...
    public Vector<String> translate() throws RemoveNameConflictsException
    {
        ...
        //System.out.println("\n" + "After exploding: " + xast.toString());
     // writing to a temprorary file the generated AST
        try {
			FileWriter fWriter = new FileWriter(new File("/home/dastan/git/DistributedPlusCal/tlatools/test-examples/XAST.txt"));
			fWriter.write(xast.toString());
			fWriter.close();
        ...
        //System.out.println("\n" + "st object from PcalSymTab: " + st.toString());
...
//            result.addAll(tlaGenerator.generate(xast, st));
        ...
        System.out.println("Successfully generated TLA+ from xast and st");
// tla-pcal debugging
